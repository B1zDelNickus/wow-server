...
@KtorExperimentalAPI
abstract class GameServerOutputPacket : BaseOutputPacket() {

    init {
        opCode = GameServerOutputPacketsOpcodes.getOpcode(this::class)
    }
     ...
     * @param con
     */
    fun write(con: GameServerConnection, buf: ByteBuffer) {
     ...
     * @param con
     */
    protected abstract fun writeImpl(con: GameServerConnection)
