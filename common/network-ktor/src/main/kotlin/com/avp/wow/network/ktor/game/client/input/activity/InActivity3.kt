...
import com.avp.wow.network.ktor.game.client.output.activity.OutActivity3
import io.ktor.util.KtorExperimentalAPI
import kotlinx.coroutines.delay

@KtorExperimentalAPI
class InActivity3(vararg states: State) : GameClientInputPacket(OP_CODE, states.toList()) {
